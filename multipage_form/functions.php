    ...
    <div class="form-group">
        ...
        <?php foreach ( $options as $value => $title ) : ?>
            <label class="checkbox-inline" for="<?php echo $id; ?>">
                <input type="checkbox" name="<?php echo $name; ?>[]" value="<?php echo $value; ?>" <?php echo $value; ?> <?php isset($_SESSION[ 'interests' ]) ? checked($value, $_SESSION[ 'interests' ]) : ''; ?> >
...
function submit($value = 'submit', $class = 'but btn-primary') {?>
